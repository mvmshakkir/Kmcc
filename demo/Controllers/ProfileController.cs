        ...
        public IActionResult viewprofile(long? Tid)
        {
            ...
            if (userIdClaim == null) {
                ...
                else
                {
                    ...
                    var coordinator = _context.demoUser.FirstOrDefault(u => u.Id == userId && u.IsCoordinator == true);
                    if (coordinator != null)
                    {
                        return RedirectToAction("CordinatorDashboard", "Cordinators", new { userId = coordinator.Id });
                    }
