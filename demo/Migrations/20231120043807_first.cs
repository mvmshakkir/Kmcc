        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbroadPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Gender = table.Column<int>(type: "int", maxLength: 500, nullable: false),
                    UserImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Age = table.Column<int>(type: "int", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_regModel", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    regModelId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_family", x => x.familyId);
                    table.ForeignKey(
                        name: "FK_family_AspNetUsers_demoUserId",
                        column: x => x.demoUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_family_regModel_regModelId",
                        column: x => x.regModelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_family_demoUserId",
                table: "family",
                column: "demoUserId");

            migrationBuilder.CreateIndex(
                name: "IX_family_regModelId",
                table: "family",
                column: "regModelId");
        }
